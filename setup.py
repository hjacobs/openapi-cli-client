...
if sys.version_info < (3, 4, 0):
    sys.stderr.write('FATAL: OpenAPI CLI Client needs to be run with Python 3.4+\n')
    sys.exit(1)
...
MAIN_PACKAGE = 'openapi_cli_client'
...
KEYWORDS = 'openapi swagger rest api cli client'
...
CONSOLE_SCRIPTS = ['openapi-cli-client = openapi_cli_client.cli:main']
